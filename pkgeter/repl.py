...
class PkgeterREPL(cmd.Cmd):
    ...
    def do_help(self, _: str) -> None:
        ...
        print("               --repo         Generate local apt/yum repo metadata")
        ...
        print('  g nginx --distro debian-bookworm --repo')
        print('  g nginx --distro pve-8 --repo -o ./offline-repo')
        print('  s openssh --distro debian-bookworm')
        print('  s *sql* --desc')
        print('  t nginx --distro debian-bookworm')
        print('  t nginx --distro centos-9 --output ./tree.html')
        print('  r l')
